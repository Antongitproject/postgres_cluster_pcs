...
- Убедиться в наличии учетной записи с правами администратора из под которой будет производится подключение      
- Убедиться в том, что подключенны репозитории postgres, os.    
- Убедиться, что ip адреса настроены    
- Убедиться, что hostname настроен верно    
- Убедиться, что firewalld, nftables или iptables настроен (tcp: 5432, 2224 / udp: 5404, 5405).
